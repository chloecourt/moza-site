  ...
  return (
    <div className={cx(className, "my-2 flex items-center")}>
      {starIds.map((star) => (
        <svg
          key={star}
          className="h-4 w-4 text-yellow-300 min-[500px]:h-5 min-[500px]:w-5"
          fill="currentColor"
          viewBox="0 0 20 20"
      ...
      <span className="mr-2 ml-3 rounded bg-blue-100 px-2.5 py-0.5 text-[9px] font-semibold text-blue-800 dark:bg-blue-200 dark:text-blue-800 min-[500px]:text-xs">
        5.0
      </span>
    </div>
  );
